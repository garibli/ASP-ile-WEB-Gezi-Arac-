...
<div class="portlet box red col-md-8 col-md-offset-2">
            <div class="portlet-title">
              ...
              <div class="tools">
                ...
                <a href="OgrKaydiGiris.aspx" class="remove">
                </a>
              </div>
            </div>
            <div class="portlet-body form col-md-12">
              <form role="form-horizontal">
                <div class="form-body">
                 ...
                 <div class="col-md-9"> 
                    <asp:TextBox ID="txtOgrNo" runat="server" MaxLength="10"  class="form-control " placeholder="Ornek : bXXXXXXXXX veya gXXXXXXXXX veya yXXXXXXXXXX veya uXXXXXXXXX"
                 OnTextChanged="txtTC_TextChanged"></asp:TextBox>
                  </div>
                  </div>  
                  </div>
                   ...
                   <div class="form-group margin-bottom-10">
                   <div class="row col-md-12" style="margin-top:10px;">
                    <label  class="col-md-3 control-label">Mail Adresiniz</label>
                     <div class="col-md-9"> 
                    <asp:TextBox ID="txtMail" runat="server" MaxLength="50" class="form-control " placeholder="XXXXXXXX@ogr.sakarya.edu.tr"></asp:TextBox>
                  </div>
                  </div></div>
                   <div class="form-group margin-bottom-10">
                   <div class="row col-md-12" style="margin-top:10px;visibility:hidden">
                    <label  class="col-md-3 control-label">Varsa İkinci Mail Adresiniz</label>
                     <div class="col-md-9"> 
                    <asp:TextBox ID="txtIkinciMail" runat="server" MaxLength="50" class="form-control " 
                             placeholder="XXXXXXXX@XXXXXXX"></asp:TextBox>
                  </div>
                  </div></div>
           ...
           <div class="col-md-2">
            ...
            <asp:DropDownList ID="ddlNot3" runat="server" class="form-control input-sm">
                ...
                <asp:ListItem>9</asp:ListItem>
                  ...
                  <div class="form-group margin-bottom-10">
                  <div class="row col-md-12 " style="margin-top:10px">
                    <label  class="col-md-3 control-label">IBAN NO</label>
                    <div class="col-md-9">
                     <asp:TextBox ID="txtIBAN" runat="server" class="form-control " onkeydown="return onlyNumber(event)"  MaxLength="26"></asp:TextBox>
                    </div>
                  </div></div>
