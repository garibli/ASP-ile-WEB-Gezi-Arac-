...
<body>
    ...
    <div class="container">
    <div class="margin-top-20 margin-bottom-10" style="color:Blue"><div class="col-md-6" style="font-size:larger"><strong class="col-md-offset-2"> İŞLER </strong></div><div class="col-md-6" style="font-size:larger"><strong class="col-md-offset-6">ALINAN İŞLER </strong></div></div>
    <div class="col-md-6">
    <div class="col-md-11" >
    <div class="tab-content">
	<div id="tab_1" class="tab-pane active">
        <asp:DataList ID="dtListAtanmamis" runat="server"  onitemcommand="dtListAtanmamis_ItemCommand">
            <ItemTemplate>
