<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UcretBordrosu.aspx.cs" Inherits="SKSEkrani_UcretBordrosu" %>
            ...
            <FooterTemplate>
                ...
                <table class="auto-style1">
                   ...
                   -TOPLAMLAR-
                    ...
                    <tr>
                        <td class="alan00"> </td>
                        <td class="birimAdi"> </td>
                        <td class="alan22"> </td>
                        <td class="alan11"> </td>
                        <td class="alan11"> </td>
                        <td class="ogrTuru"> </td>
                        <td class="alan33"> </td>
                        <td class="alan33">Toplamlar </td>
                       <%-- <td class="GSS"> </td>--%>
                        <td class="GSS"></td>
                        <td class="alan6">
                            <asp:Label ID="lblTopSaat" runat="server" Text=""></asp:Label>
                            </td>
                        <td class="alan6">
                           <%-- <asp:Label ID="lblTopGun" runat="server" Text=""></asp:Label>--%>
                            </td>
                        <td class="alan6">
                            <%--<asp:Label ID="lblTopSaatBrut" runat="server" Text=""></asp:Label>--%>
                            </td>            
                        <%--<td class="alan6">
                            <asp:Label ID="lblTopAsgariGunluk" runat="server" Text=""></asp:Label>
                            Asgari Günlük Brüt Ücret </td>--%>
                        <td class="alan6">
                            <asp:Label ID="lblTopAylikBrut" runat="server" Text=""></asp:Label>
                            </td>
                        <td class="alan4">
                            <asp:Label ID="lblTopSGKPrimHesabiEsas" runat="server" Text=""></asp:Label>
                            </td>
                       <%-- <td class="alan4">
                            <asp:Label ID="Label7" runat="server" Text=""></asp:Label>
                            SGK Prim Hesabına  Esas Ücret Bildirimi--</td>--%>
                        <td class="alan4">
                            <asp:Label ID="lblTopSGKYuzde5" runat="server" Text=""></asp:Label>
                            </td>
                        <td class="alan4">
                            <asp:Label ID="lblTopGelirVergisiEsas" runat="server" Text=""></asp:Label>
                           </td>
                        <td class="alan4">
                            <asp:Label ID="lblTopGelirVergisiKes" runat="server" Text=""></asp:Label>
                            </td>
                        <td class="alan4">
                            <asp:Label ID="lblTopDamgaVergisiKes" runat="server" Text=""></asp:Label>
                           </td>
                        <td class="alan4">
                            <%--<asp:Label ID="lblYasalKesOncesiTop" runat="server" Text=""></asp:Label>
                            Yasal Kesinti Öncesi Brüt--%></td>
                        <td class="alan4">
                            <asp:Label ID="lblYasalKesTop" runat="server" Text=""></asp:Label>
                            </td>
                        <td class="alan4">
                            <asp:Label ID="LblTopAgi" runat="server" Text=""></asp:Label>
                            </td>
                        <td class="alan4">
                            <asp:Label ID="lblTopNetUcret" runat="server" Text=""></asp:Label>
                            </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <%--  <td class="GSS">GSS (43)</td>--%>
                       ...
                       <%-- <td class="alan4">SGK Prim Hesabına  Esas Ücret hesabı</td>--%>
                        ...
                        <td class="alan4">Mahsup edilen A.G.İ.</td>
