...
public partial class SKSEkrani_Banka : System.Web.UI.Page
{
          ...
          //yeniSatir[0] = i.ToString();
            ...
            yeniSatir[11] = ogrBirimFiyat;
                 ...
                 //   gelirVergisiTutari = gelirVergisiOncesiCikanTutar * bordroIslem.getirGelirVergisiOrani();
                    ...
                    if (calisanSaat != 0)
                        yeniSatir[18] = yasalKesOncesiBrut = Math.Round((gelirVergisiOncesiCikanTutar - damgaVergisiTutari), 2, MidpointRounding.AwayFromZero);
                    else
                        yeniSatir[18] = 0;
