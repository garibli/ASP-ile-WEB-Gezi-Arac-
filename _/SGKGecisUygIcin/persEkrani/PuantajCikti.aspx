        ...
        <asp:DataList ID="DataList1" runat="server" OnItemDataBound="DataList1_ItemDataBound">
            <FooterTemplate>
                <table class="auto-style2">
                    ...
                    <tr>
                        <td class="footerAlan1" style="text-align: center;">HAZIRLAYAN :      
                           </td>
                        <td class="footerAlan1" style="text-align: center;">ONAYLAYAN : </td>
                    </tr>
                    <tr>
                        <td class="footerAlan1">ADI SOYADI :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblHazirlayan" runat="server" Text="" CssClass="center"></asp:Label></td>
                        <td class="footerAlan1">ADI SOYADI :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblOnaylayan" runat="server" Text="" CssClass="center"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="footerAlan1">ÜNVANI :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblHazirlayanUnvan" runat="server" Text=""></asp:Label></td>
                        <td class="footerAlan1">ÜNVANI :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblOnaylayanUnvan" runat="server" Text=""></asp:Label></td>
                    </tr>
                    <tr>
