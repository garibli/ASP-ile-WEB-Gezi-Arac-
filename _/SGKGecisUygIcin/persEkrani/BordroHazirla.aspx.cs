...
public partial class persEkrani_BordroHazirla : System.Web.UI.Page
{
    ...
    protected void btnOlustur_Click(object sender, EventArgs e)
    {
        if (ddlAy.SelectedValue != "" && ddlYil.SelectedValue != "")
        {
            ...
            var bordroVarmi = from bordro in turna.tblOgrenciMaas
                              ...
                              && bordro.calistigiBirimID == birimID
    ...
    {
        Response.Redirect("ftp://skscalisma.sakarya.edu.tr/App_Data/XML/");
    }
